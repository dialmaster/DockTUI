"""Refresh and UI update actions for dockerview."""
...
logger = logging.getLogger("dockerview.actions.refresh")
...
class RefreshActions:
    ...
    async def refresh_containers(self: "DockerViewApp") -> None:
    ...
    def _handle_refresh_results(
        self: "DockerViewApp", networks, stacks, images, volumes, containers
    ):
