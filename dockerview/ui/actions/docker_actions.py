"""Docker command execution actions for dockerview."""
...
logger = logging.getLogger("dockerview.actions.docker")
...
class DockerActions:
    ...
    def is_action_applicable(self: "DockerViewApp", action: str) -> bool:
    ...
    def execute_docker_command(self: "DockerViewApp", command: str) -> None:
    ...
    def handle_post_recreate(
        self: "DockerViewApp", containers: list
