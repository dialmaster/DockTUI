...
from dockerview.ui.widgets.headers import NetworkHeader, SectionHeader, StackHeader, VolumeHeader
...
class TestContainerList:
    ...
    def container_list(self):
        ...
        with patch('dockerview.ui.base.container_list_base.ContainerListBase.__init__', return_value=None):
    ...
    def test_on_mount_initial_load(self, container_list):
        ...
        with patch.object(type(container_list), 'children', new_callable=PropertyMock) as mock_children:
            ...
            with patch('dockerview.ui.containers.Static') as mock_static_cls:
